...
Version: 2.0.0 (refonte unifiée — VFS + modules étendus + rapport forensique)
...
class AutelApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Autel Forensics Analyzer PRO v2.0.0")
    ...
    def _build_ui(self):
        ...
        tk.Label(self, text="AFAP v2.0.0 | Créé par Vincent Chapeau", font=("Arial", 9), fg="black").place(relx=1.0, rely=1.0, anchor='se')
